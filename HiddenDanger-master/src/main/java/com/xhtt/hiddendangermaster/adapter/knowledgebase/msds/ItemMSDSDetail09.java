...
public class ItemMSDSDetail09 implements ZItemViewDelegate<MSDSDetail> {

    @Override
    public int getItemViewLayoutId() {
        return R.layout.item_msds_detail_09;
    }

    @Override
    public boolean isForViewType(MSDSDetail item, int position) {
        return item.getItemType() == Constants.LIST_ITEM_TYPE_9;
    }
    ...
    public void convert(ZViewHolder holder, MSDSDetail item, int position) {
        ...
        holder.setText(R.id.tv_m9, clearFormat(item.getTexts()[8]));
        holder.setText(R.id.tv_m10, clearFormat(item.getTexts()[9]));
        holder.setText(R.id.tv_m11, clearFormat(item.getTexts()[10]));
        holder.setText(R.id.tv_m12, clearFormat(item.getTexts()[11]));
        holder.setText(R.id.tv_m13, clearFormat(item.getTexts()[12]));
        holder.setText(R.id.tv_m14, clearFormat(item.getTexts()[13]));
        holder.setText(R.id.tv_m15, clearFormat(item.getTexts()[14]));
        holder.setText(R.id.tv_m16, clearFormat(item.getTexts()[15]));
    }
