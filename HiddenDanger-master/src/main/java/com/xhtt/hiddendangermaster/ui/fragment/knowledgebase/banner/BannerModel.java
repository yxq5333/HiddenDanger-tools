...
public class BannerModel implements BannerContract.Model {
    ...
    public BannerModel(BannerContract.View mView) {
        this.mView = mView;
    }
    ...
    public void getData(Map<String, Object> request) {
        ...
        RequestParams params = new RequestParams(IPConfigHelper.create().getNowIPConfig().getRequestUrl(InterfaceApi.BannerList.getUrl()));
            ...
            public void onGetSuccess(String result) {
                ...
                if (isViewAttached()) {
                    if (responseInfo.getCode() == ResponseInfo.CODE_SUCCESS) {
                        new Thread(() -> {
                            ArrayList<Banner> tempData = new Gson().fromJson(
