...
public class CheckTableListModel implements CheckTableListContract.Model {
    ...
    public void getData(Map<String, Object> request) {
        ...
        RequestParams params = new RequestParams(ZIPConfigHelper.get().getNowIPConfig().getRequestUrl(InterfaceApi.CheckTableList.getUrl()));
    ...
    public void deleteData(ArrayList<Long> request) {
        ...
        RequestParams params = new RequestParams(ZIPConfigHelper.get().getNowIPConfig().getRequestUrl(InterfaceApi.CheckTableDelete.getUrl()));
